...
import { Swords, Shield, Sparkles, Lock } from 'lucide-react'
...
export default function LoginPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    console.log('🔐 Tentative de connexion:', { username, pin })

    try {
      await signIn(username, pin)
      console.log('✅ Connexion réussie, redirection vers /activities')
    ...
    <div className="min-h-screen flex items-center justify-center p-4 relative overflow-hidden">
      ...
      <div className="w-full max-w-md relative z-10 animate-fade-in">
        ...
        <Card className="glass-effect border-slate-700/50 shadow-2xl backdrop-blur-xl card-hover">
          <CardHeader className="space-y-1 pb-6">
            ...
            <CardDescription className="text-slate-400">
              Connectez-vous avec votre pseudo et PIN
            </CardDescription>
          </CardHeader>
          <CardContent>
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <div className="space-y-2">
                <Label htmlFor="username" className="text-slate-300 font-medium">Pseudo</Label>
                <Input
                  id="username"
                  type="text"
              ...
              <div className="space-y-2">
                <Label htmlFor="pin" className="text-slate-300 font-medium">Code PIN</Label>
                <div className="relative">
                  ...
                  <Input
                    ...
                    required
                    maxLength={4}
                    className="bg-slate-900/50 border-slate-700 text-white placeholder:text-slate-500 focus:border-purple-500 focus:ring-purple-500/20 h-11 pl-10 text-center text-2xl tracking-widest transition-all"
                  />
                </div>
        ...
        <div className="mt-6 text-center text-xs text-slate-500">
          <p>Albion Zerg Manager v2.0 - Made with ❤️ for the community</p>
        </div>
      </div>
    </div>
  )
